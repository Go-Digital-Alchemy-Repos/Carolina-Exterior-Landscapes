...
const seoFormSchema = z.object({
  ...
  titleSuffix: z.string().default(" | Website"),
...
const ROADMAP_ITEMS = [
  ...
  },
  {
    icon: SearchIcon,
    title: "Media SEO",
    description: "Uploaded media supports alt text, captions, and reusable social image metadata.",
    status: "available",
  },
  {
    icon: Code2,
    title: "Structured Data / JSON-LD",
    description: "Organization, WebSite, BreadcrumbList, and FAQPage data are generated from CMS content where the needed fields exist.",
    status: "available",
  },
  {
    icon: Map,
    title: "Sitemap Generation",
    description: "Auto-generated /sitemap.xml from published CMS pages. Draft and noindex content is automatically excluded.",
    status: "available",
  },
  {
    icon: ListChecks,
  ...
  },
  {
    icon: BarChart2,
    title: "SEO Audit",
    description: "Scans CMS pages for missing SEO title, meta description, social image, noindex flags, and publication status.",
    status: "available",
  },
];
  ...
  useEffect(() => {
    if (settings) {
      form.reset({
        ...
        titleSuffix: settings.titleSuffix ?? " | Website",
        defaultMetaDescription: settings.defaultMetaDescription ?? "",
        siteUrl: settings.siteUrl ?? "",
        defaultOgImageUrl: settings.defaultOgImageUrl ?? "",
        organizationName: settings.organizationName ?? "Website",
                  ...
                  <Card>
                    <CardHeader className="pb-3">
                      ...
                      <CardDescription className="text-xs">
                        Identity values used across SEO tags and structured data
                      </CardDescription>
                    </CardHeader>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormDescription className="text-xs">
                              Appended to page titles, for example "Services | Website"
                            </FormDescription>
                            <FormMessage />
                          </FormItem>
                        )}
