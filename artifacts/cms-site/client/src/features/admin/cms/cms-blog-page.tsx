...
import { CalendarClock, Eye, EyeOff, MessageSquare, Newspaper, Pencil, Plus, Search, Settings, Trash2 } from "lucide-react";
                      ...
                      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div className="min-w-0 space-y-2">
                          ...
                          <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-sm text-muted-foreground">
                            <span>{meta.publishedDate ? format(new Date(meta.publishedDate), "MMM d, yyyy") : "No date"}</span>
                            <span>·</span>
