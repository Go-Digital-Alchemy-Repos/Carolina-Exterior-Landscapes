...
export function BrandingProvider({ children }: { children: React.ReactNode }) {
  ...
  const { data } = useQuery<BrandingSettings>({
    ...
    queryFn: async () => {
      ...
      return {
        ...
        companyHours: payload?.companyHours ?? null,
        companyLicense: payload?.companyLicense ?? null,
        companyLicensing: payload?.companyLicensing ?? null,
        companyCredentials: payload?.companyCredentials ?? null,
  ...
  useEffect(() => {
    ...
    branding.companyCredentials,
    branding.companyEmail,
    branding.companyGoogleBusinessUrl,
    branding.companyHours,
    branding.companyLicense,
    branding.companyLicensing,
