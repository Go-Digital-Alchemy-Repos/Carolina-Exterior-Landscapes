...
const STATIC_PAGE_SNAPSHOTS: Array<Pick<PublicHtmlSnapshot, "title" | "description" | "bodyHtml" | "jsonLd"> & { path: string; h1: string }> = [
  {
    path: "/blog",
    h1: "Landscaping & Lawn Care Journal",
    title: `Landscaping & Lawn Care Blog | ${BRAND.name}`,
    description: "Practical lawn care, landscaping, hardscape, drainage, HOA, and commercial grounds maintenance advice for Waxhaw, Union County, and the Charlotte region.",
  ...
  },
  {
    ...
    description: "See residential and commercial landscaping, hardscape, lawn care, drainage, and grounds maintenance work from Carolina Exterior Landscapes.",
    bodyHtml: renderArticleBody({
      h1: "Landscaping & Hardscape Gallery",
      blocks: [
        { type: "p", text: "Explore examples of outdoor spaces, commercial grounds, plantings, hardscape features, and maintained properties completed by Carolina Exterior Landscapes." },
      ],
    }),
    jsonLd: [],
  },
  {
    ...
    description: "Commercial grounds maintenance, landscaping, hardscape, drainage, and HOA project examples from Carolina Exterior Landscapes.",
    bodyHtml: renderArticleBody({
      h1: "Commercial Landscaping Portfolio",
      blocks: [
        { type: "p", text: "Review commercial landscaping and grounds maintenance work for office, retail, HOA, multi-family, and business properties across Union County and the Charlotte region." },
      ],
    }),
    jsonLd: [],
  },
  {
    ...
    description: "Contact Carolina Exterior Landscapes for lawn care, landscaping, hardscape, drainage, HOA, and commercial grounds maintenance in Waxhaw and Union County.",
    bodyHtml: renderArticleBody({
      h1: "Contact Carolina Exterior Landscapes",
      blocks: [
        { type: "p", text: "Tell us about your lawn care, landscaping, hardscape, mulching, planting, or drainage needs. We respond to inquiries within one business day." },
        { type: "h2", text: "Request a Landscaping Quote" },
        { type: "p", text: "Call Carolina Exterior Landscapes at (704) 975-5867 or use the contact form to request a residential or commercial property assessment." },
      ],
    }),
    jsonLd: [],
  },
  {
    ...
    description: "Professional pressure washing for driveways, walkways, patios, home exteriors, fences, and hardscape throughout Waxhaw and the greater Charlotte area.",
    bodyHtml: renderArticleBody({
      h1: "Residential Pressure Washing",
      blocks: [
        { type: "p", text: "Restore driveways, walkways, patios, porches, home exteriors, fences, walls, and hardscape with professional residential pressure washing." },
        { type: "h2", text: "Exterior Cleaning for Homes and Outdoor Spaces" },
        { type: "p", text: "Carolina Exterior Landscapes provides pressure washing services throughout Waxhaw, Union County, and the greater Charlotte area." },
      ],
    }),
    jsonLd: [],
  },
  {
    ...
    description: "Scheduled commercial pressure washing for sidewalks, storefronts, concrete, dumpster pads, and HOA common areas across the greater Charlotte region.",
    bodyHtml: renderArticleBody({
      h1: "Commercial Pressure Washing",
      blocks: [
        { type: "p", text: "Maintain clean sidewalks, storefronts, entries, concrete, curbs, dumpster pads, service areas, and HOA amenities with scheduled commercial pressure washing." },
        { type: "h2", text: "Commercial Exterior Cleaning" },
        { type: "p", text: "Flexible service plans support office, retail, multi-family, HOA, and commercial properties across Union County and the greater Charlotte region." },
      ],
    }),
    jsonLd: [],
  },
  buildFaqSnapshot("/faq", "Residential FAQ", "Residential FAQ", "Frequently asked questions about residential lawn maintenance, landscaping, hardscape, planting, mulching, and drainage services.", [
  ...
  buildFaqSnapshot("/commercial-faq", "Commercial & HOA FAQ", "Commercial FAQ", "Frequently asked questions about commercial landscaping, HOA grounds maintenance, commercial hardscape, and drainage services.", [
    "commercial",
...
function buildFaqSnapshot(pathname: string, titlePrefix: string, h1: string, description: string, slugs: string[]) {
...
function buildLocationSnapshot(location: LocationContent): PublicHtmlSnapshot {
  ...
  return {
    ...
    ogImageUrl: absoluteLandscapeImage(location.slug === "matthews-nc" ? "matthews-nc-hero.webp" : "community-aerial.webp"),
    ...
    jsonLd: [
      ...
      ]),
      {
        ...
        description: location.metaDescription,
        provider: { "@type": "LocalBusiness", "@id": `${BRAND.domain}/#localbusiness`, name: BRAND.name },
...
function buildStaticSnapshot(staticPage: (typeof STATIC_PAGE_SNAPSHOTS)[number]): PublicHtmlSnapshot {
  const staticImage = staticPage.path === "/commercial-portfolio"
...
export function injectPublicHtmlSnapshot(template: string, snapshot: PublicHtmlSnapshot | null) {
  ...
  const headParts = [
    ...
    snapshot.ogImageAlt ? `<meta property="og:image:alt" content="${escapeHtml(snapshot.ogImageAlt)}" />` : "",
  ...
  return normalizedTemplate
    .replace(/<title>[\s\S]*?<\/title>/i, () => `<title>${escapeHtml(compactMetaTitle(snapshot.title))}</title>`)
