...
import { useCreateCommercialQuote } from "@workspace/api-client-react";
import { getPage } from "@/content";
import { Seo } from "@/components/Seo";
import { COMMERCIAL_SERVICE_OPTIONS, PROPERTY_TYPES } from "@/content/site";
...
export default function CommercialQuote() {
  ...
  const page = getPage("commercial-quote");
  ...
  const createQuote = useCreateCommercialQuote();
