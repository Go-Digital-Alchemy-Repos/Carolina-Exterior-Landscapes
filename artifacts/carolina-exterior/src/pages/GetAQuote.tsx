...
import { useCreateResidentialQuote } from "@workspace/api-client-react";
import { getPage } from "@/content";
import { Seo } from "@/components/Seo";
import { QUOTE_SERVICE_OPTIONS } from "@/content/site";
...
export default function GetAQuote() {
  ...
  const page = getPage("get-a-quote");
  ...
  const createQuote = useCreateResidentialQuote();
