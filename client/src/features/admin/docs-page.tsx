...
export default function DocsPage() {
  ...
  return (
    <AdminSidebar>
      <div className="flex min-h-0 flex-col gap-6 p-4 sm:p-6 xl:h-[calc(100vh-4rem)] xl:overflow-hidden">
        ...
        <div className="grid min-h-0 flex-1 gap-6 xl:grid-cols-[260px_340px_minmax(0,1fr)] xl:overflow-hidden">
          <Card className="flex min-h-0 flex-col overflow-hidden">
            ...
            <CardContent className="flex min-h-0 flex-1 flex-col overflow-hidden pb-4">
              <ScrollArea className="max-h-72 min-h-0 flex-1 pr-3 xl:max-h-none">
          ...
          <Card className="flex min-h-0 flex-col overflow-hidden">
            ...
            <CardContent className="flex min-h-0 flex-1 flex-col overflow-hidden pb-4">
              <ScrollArea className="max-h-[32rem] min-h-0 flex-1 pr-3 xl:max-h-none">
            ...
            {selectedDoc ? (
              <>
                    ...
                    <div className="space-y-3">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                          System and editorial documentation for the website.
                        </p>
                      </div>
                      <div className="flex flex-wrap gap-2">
                ...
                <CardContent className="flex min-h-0 flex-1 flex-col overflow-hidden pb-4 pt-6">
                  <ScrollArea className="max-h-[70vh] min-h-0 flex-1 pr-4 xl:max-h-none">
                    <MarkdownDocument
