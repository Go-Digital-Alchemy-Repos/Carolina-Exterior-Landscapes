...
const ROADMAP_ITEMS = [
  ...
  },
  {
    ...
    description:
      "Organization, WebSite, BreadcrumbList, and FAQPage data are generated from CMS content where the needed fields exist.",
    status: "available",
  },
  {
    icon: Map,
    ...
    description:
      "Auto-generated /sitemap.xml from published CMS pages. Draft and noindex content is automatically excluded.",
    status: "available",
  },
  {
    icon: ListChecks,
  ...
  },
  {
    ...
    title: "SEO Audit",
    description:
      "Scans CMS pages for missing SEO title, meta description, social image, noindex flags, and publication status.",
    status: "available",
  },
];
