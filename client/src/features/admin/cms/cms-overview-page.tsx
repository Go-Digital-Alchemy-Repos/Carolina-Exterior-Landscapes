...
export default function CmsOverviewPage() {
  ...
  const quickLinks = [
    {
      title: "Pages",
      description: "Create and manage public website pages",
      icon: FileCode,
    ...
    {
      title: "Forms",
      description: "Manage generic public forms and submissions",
      icon: SquarePen,
      href: "/admin/forms",
    },
    {
      title: "Galleries",
      description: "Create reusable photo galleries",
      icon: Images,
    ...
    {
      title: "Sections",
      description: "Save and reuse block groups",
      icon: Blocks,
      href: "/admin/cms/sections",
    },
    {
      title: "SEO Settings",
      description: "Configure global SEO, robots, and sitemap settings",
      icon: SearchIcon,
      href: "/admin/cms/seo",
    },
  ];
    ...
    <AdminSidebar>
      <div className="mx-auto max-w-6xl space-y-6 p-4 sm:p-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold" data-testid="text-cms-title">
              Content Management System
            </h1>
            <p className="mt-1 text-muted-foreground">
              Manage public CMS pages, forms, media, sections, and SEO.
            </p>
          </div>
