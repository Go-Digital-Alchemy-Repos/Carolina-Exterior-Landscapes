...
const COLUMN_SORTS: Record<
  SortableColumn,
  { asc: CmsPageSort; desc: CmsPageSort; defaultDirection: SortDirection }
> = {
...
function getSortState(sort: CmsPageSort): {
  column: SortableColumn | null;
  direction: SortDirection | null;
} {
  for (const [column, values] of Object.entries(COLUMN_SORTS) as Array<
    [SortableColumn, (typeof COLUMN_SORTS)[SortableColumn]]
  >) {
...
export default function CmsPagesPage() {
  ...
  const visiblePages = useMemo(
    () => filterAndSortStandardCmsPages(pages, search, sort),
    [pages, search, sort],
  );
    ...
    return (
      ...
      >
        ...
        >
          {label}
          <Icon
            className={`h-3.5 w-3.5 ${isActive ? "text-foreground" : "text-muted-foreground/60"}`}
          />
        </button>
      </th>
    );
        ...
        <Card>
          <CardContent className="space-y-4 pt-6">
              ...
              <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="grid gap-3 sm:grid-cols-[170px_220px] lg:flex lg:items-center">
                  <div
                    ...
                    data-testid="text-pages-result-count"
                  >
            ...
            {isLoading ? (
              ...
              <div
                className="text-center py-16 text-muted-foreground"
                data-testid="text-empty-page-search"
              >
              ...
              <>
                <div className="space-y-3 md:hidden" data-testid="cards-cms-pages">
                    ...
                    return (
                      ...
                      >
                        <button
                          ...
                          onClick={() => !isLockedByOther && navigate(getEditorHref(page))}
                          disabled={isLockedByOther}
                        >
                          <div className="flex items-start justify-between gap-3">
                            <div className="min-w-0">
                              <h2 className="font-semibold leading-snug">{page.title}</h2>
                            ...
                            <Badge
                              ...
                              className={cn(
                                "shrink-0 capitalize",
                                page.status === "published" && "bg-green-600",
                          ...
                          <div className="mt-3 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                            <span
                              className={cn(
                                ...
                                PAGE_TYPE_COLORS[page.pageType] ?? PAGE_TYPE_COLORS.custom,
                              )}
                            >
                              {page.pageType}
                            </span>
                        ...
                        <div className="mt-4 grid grid-cols-3 gap-2 border-t pt-3">
                          ...
                          {page.status === "published" || page.status === "scheduled" ? (
                            ...
                            >
                              <EyeOff className="mr-1.5 h-4 w-4" /> Draft
                            </Button>
                          ) : (
                            <Button
                              variant="outline"
                              className="min-h-11 text-green-700"
                ...
                <table className="hidden w-full text-sm md:table" data-testid="table-cms-pages">
                  <thead>
