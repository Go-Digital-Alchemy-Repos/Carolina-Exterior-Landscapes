...
export function PageBuilder({ content, onChange }: PageBuilderProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Button
            ...
            data-testid="button-mobile-builder-inspector"
          >
      ...
      <MobileBuilderLayout
        structurePanelOpen={mobileStructureOpen}
        advancedInspectorOpen={mobileInspectorOpen}
        onSetStructurePanelOpen={setMobileStructureOpen}
        onSetAdvancedInspectorOpen={setMobileInspectorOpen}
