...
function secretInputProps(stored: boolean, save: (value: string, onSaved: () => void) => void) {
  return {
...
function GoogleReviewsVerificationHelp({ message }: { message: string }) {
  ...
  return (
    <div
      role="alert"
      className="mt-4 rounded-md border border-red-200 bg-red-50 p-4 text-sm text-red-950"
    >
        ...
        <div className="space-y-3">
          ...
          {hasReferrerRestrictionError ? (
            <div className="space-y-2">
              <p>
                This key is restricted to browser referrers, but Google Reviews is requested
                securely by the website server. Update the key in Google Cloud:
              </p>
              <ol className="list-decimal space-y-1 pl-5">
                <li>Open the API key under Google Cloud API Credentials.</li>
                <li>
                  Change Application restrictions from Websites to None. If the server has a static
                  outbound IP, IP addresses may be used instead.
                </li>
                <li>Under API restrictions, restrict the key to Places API (New), then save.</li>
                <li>
                  Allow a few minutes for Google&apos;s changes to apply, then click Verify
                  Connection.
                </li>
              </ol>
            </div>
            ...
            <p>
              Confirm that the key is valid, billing is active, Places API (New) is enabled, and the
              Place ID is correct. Save any changes in Google Cloud, then click Verify Connection.
            </p>
          )}
...
export default function AdminSettingsPage({
  ...
  const updateFormRecipient = useMutation({
    mutationFn: async ({
      ...
      const current = Array.isArray(user.formNotificationFormIds)
  ...
  const canValidateGoogleReviews =
    googleReviewsEnabled && Boolean(googleReviewsPlaceId && googleReviewsApiKeyStored);
      ...
      <div className="mx-auto max-w-5xl space-y-6 p-4 sm:p-6">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Generic backend configuration for email, analytics, and integrations.
          </p>
        </div>
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="grid gap-4 md:grid-cols-2">
                ...
                >
                  Use a verified sending domain from Mailgun for the domain field. The from address
                  should use that verified domain, such as{" "}
                  <span className="font-medium text-foreground">noreply@mg.example.com</span>.
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input
                    id="mailgun-key"
                    {...secretInputProps(
                      Boolean(mailgun.mailgun_api_key?.value),
                      (value, onSaved) => {
                        saveSetting.mutate(
              ...
              <CardContent className="space-y-4">
                <SetupInstructions
                  ...
                  links={[
                    ...
                    {
                      label: "Find a Measurement ID",
                      href: "https://support.google.com/analytics/answer/12270356",
                    },
                  ]}
                >
                  In Google Analytics, open Admin, choose the property for this website, then open
                  Data Streams and select the web stream. Copy the Measurement ID that starts with{" "}
                ...
                <div className="rounded-md border p-4">
                  <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-start">
                      ...
                      <div className="flex items-center gap-2">
                        <Label htmlFor="google-reviews-enabled" className="text-sm">
                          Enabled
                        </Label>
                        <Switch
                  ...
                  <div className="mt-4">
                    <SetupInstructions
                      ...
                      links={[
                        {
                          label: "Google Cloud API Credentials",
                          href: "https://console.cloud.google.com/apis/credentials",
                        },
                        {
                          label: "Enable Places API",
                          href: "https://console.cloud.google.com/apis/library/places-backend.googleapis.com",
                        },
                        {
                          label: "Find a Place ID",
                          href: "https://developers.google.com/maps/documentation/javascript/examples/places-placeid-finder",
                        },
                      ]}
                    >
                      In Google Cloud, enable the Places API for the project and create an API key
                      under APIs & Services. Under API restrictions, limit the key to Places API
                      (New). Because reviews are requested by the website server, do not use a
                      Websites/referrer application restriction; use None, or an IP address
                      restriction only when the server has a static outbound IP. Use Google&apos;s
                      Place ID Finder to search for the business listing, then copy the Place ID
                      that starts with <span className="font-medium text-foreground">ChIJ</span>.
                    </SetupInstructions>
                  </div>
                  ...
                  <div className="mt-4 grid gap-4 md:grid-cols-2">
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-xs text-muted-foreground">
                        Use a Google language code such as en or es.
                      </p>
                    </div>
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-xs text-muted-foreground">
                        Controls how often the public carousel refreshes from Google.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 flex flex-wrap items-center gap-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Verification also runs automatically after credentials are saved. The public
                      section only displays reviews returned by Google with a 5-star rating.
                    </p>
                  </div>
                </div>
              </CardContent>
